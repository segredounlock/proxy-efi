...
namespace iSkorpionA12
{
    ...
    public static class iOSDevice2
    {
        ...
        {
            if (iOSDevice2.Model.Contains("GSM"))
            {
                return false;
            }

            if (iOSDevice2.Model.Contains("iPod") || iOSDevice2.Model.Contains("iPad"))
            {
                return true;
            }

            if (iOSDevice2.Model.Contains("CDMA")
                || iOSDevice2.Model.Contains("iPhone 6")
                || iOSDevice2.Model.Contains("iPhone SE")
                || iOSDevice2.Model.Contains("Global")
                || iOSDevice2.Model.Contains("iPod")
                || iOSDevice2.Model.Contains("iPad")
                )
            {
                return true;
            }
